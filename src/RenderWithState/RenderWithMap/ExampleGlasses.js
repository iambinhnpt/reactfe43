...
export default class ExampleGlasses extends Component {
    state = {
        glassesList: [
            ...
            { id: 5, price: 32, name: 'PRADA P8750', url: './img/glassesImage/v5.png', desc: 'Light pink square lenses define these sunglasses, ending with amother of pearl effect tip. ' },
